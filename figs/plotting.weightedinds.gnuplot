...
fftfile = "data_fs/processed/deconvolve.fft"
## Last datafile plotted: "data_fs/processed/deconvolve.out"
plot file u 1:2 lw 4 w impulses,file u 1:($4+1),file u 1:($8*1e-1),file u 1:($11-$1) w histeps lw 2
#    EOF

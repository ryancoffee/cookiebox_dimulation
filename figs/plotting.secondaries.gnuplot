...
set yrange [1e-5:1]
set key at screen .4,.2 left
#set title 'data MgO from Whetten \& Laponsky PRL v107 p1521 (1957)'
set label 1 'model function g(x,b,p) = tanh(x/b)**(2-p) * (x/b)**(p)' at screen .5,.15 center
plot 'references/SEspeectrum.100eV.dat' u 1:2 title '100eV impact e-',\
	'references/SEspeectrum.800eV.dat' u 1:($2/10.) title '800eV (/10)',\
	'references/SEspeectrum.2400eV.dat' u 1:($2/100) title '2400eV (/100)',\
